...
export default {
  ...
  created () {
    ...
    console.log({ "sel": { "id": 0, "type": "", "addport": "", "user": "", "pwd": "", "info": "", "isSet": true, "_temporary": true }, "columns": [{ "field": "type", "title": "远程类型", "width": 120 }, { "field": "addport", "title": "连接地址", "width": 150 }, { "field": "user", "title": "登录用户", "width": 120 }, { "field": "pwd", "title": "登录密码", "width": 220 }, { "field": "info", "title": "其他信息" }, { "field": "stimo", "title": "时间", "type": "Stimo" }], "data": [{ "id": 0, "type": "", "addport": "", "user": "", "pwd": "", "info": "", "isSet": true, "_temporary": true }] }
    )
    this.generateId = {
      _count: 1,
